  ...
  return (
    <section className="bg-white border-2 border-grey rounded-2xl p-8 shadow-sm animate-fade-in-up">
      <div className="mb-6 flex items-center justify-between gap-4">
        <h2 className="text-darkBlue text-3xl font-bold tracking-wide text-center flex-1">
          Comptage des pixels
        </h2>
        <button
          type="button"
          onClick={handleAutoCount}
          className="rounded-lg bg-blue px-4 py-2 text-sm font-semibold text-white border-2 border-blue hover:bg-blue-hover transition-colors shrink-0"
        >
          Compter automatiquement
        </button>
      </div>
      <div className="space-y-6">
        <p className="text-astro text-center text-lg font-medium leading-relaxed">
