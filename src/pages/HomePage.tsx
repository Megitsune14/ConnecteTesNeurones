          ...
          <Card hover className="group flex flex-col">
            ...
            <div className="mt-auto flex flex-wrap gap-2">
              ...
              <Link
                ...
                className="inline-flex min-h-11 items-center justify-center rounded-xl bg-blue px-4 py-2.5 text-sm font-semibold text-white shadow transition hover:bg-blue-hover focus:outline-none focus:ring-2 focus:ring-blue/40"
              >
                Grand Public
              </Link>
            </div>
